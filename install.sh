...
echo "  sed \"s|{{PHONECONTROL_USER}}|$USER|g; s|{{PHONECONTROL_DIR}}|$(pwd)|g; s|{{ADB_VENDOR_KEYS}}|$HOME/.android|g\" phonecontrol.service.template | sudo tee /etc/systemd/system/phonecontrol.service >/dev/null"
